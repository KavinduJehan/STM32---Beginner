...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Main program body - Switch Controlled LED
  ******************************************************************************
  * @attention
  *
  * This example demonstrates LED control using a push button switch
  * Target: STM32F103C8T6 (Blue Pill)
  * LED connected to PC13 (onboard LED)
  * Switch connected to PA0 (with internal pull-up)
  *
  ******************************************************************************
  */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    {
      // Switch pressed (active high) - Turn ON LED (PC13 is active low)
